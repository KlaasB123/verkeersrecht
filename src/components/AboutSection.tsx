        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-muted-foreground text-lg leading-relaxed mb-6">
              Met meer dan 30 jaar ervaring aan de balie van Limburg is Erwin Govarts een van de meest doorgewinterde specialisten in het verkeersrecht in België. Sinds de oprichting van zijn kantoor in 1993 heeft hij talloze cliënten bijgestaan in uiteenlopende verkeerszaken, van rijverboden en alcoholintoxicatie tot verkeersongevallen en complexe schadedossiers.
            </p>
            ...
            <div className="flex items-center gap-2 text-muted-foreground mb-8">
              ...
              <span className="text-sm italic">Afgestudeerd aan de KU Leuven in 1993</span>
            </div>
