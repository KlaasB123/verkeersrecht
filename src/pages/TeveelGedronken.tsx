...
const TeveelGedronken = () => {
  return (
    <ServicePageLayout title="Teveel gedronken?" icon={Wine} subLinks={subLinks} metaDescription="Betrapt op rijden onder invloed? Advocaat verkeersrecht in Hasselt – Govarts staat u bij voor rijbewijsintrekking, rijverbod, herstelexamens en medische proeven.">
