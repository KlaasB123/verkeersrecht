...
const PvOntvangen = () => {
  return (
    <ServicePageLayout title="Een PV ontvangen?" icon={FileText} subLinks={subLinks} metaDescription="PV ontvangen voor een verkeersovertreding? Advocaat verkeersrecht in Hasselt – Govarts adviseert over onmiddellijke inning, bevel tot betalen en geldboete in heel België.">
