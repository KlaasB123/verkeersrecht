...
const Gedagvaard = () => {
  return (
    <ServicePageLayout title="Gedagvaard?" icon={FileWarning} subLinks={subLinks} metaDescription="Gedagvaard voor de politierechtbank? Advocaat verkeersrecht in Hasselt – Advocatenkantoor Govarts staat u bij in heel België met 30+ jaar ervaring. Gratis eerste contact.">
