  ...
  return (
    <ServicePageLayout title="Geldboete" icon={FileText} subLinks={subLinks}>
      ...
      <p className="mb-6">
        ...
        <a href="http://www.wegcode.be/boeteberekening" target="_blank" rel="noopener noreferrer" className="text-lime hover:underline">
      ...
      <p className="mb-6">
        ...
        <a href="http://wegcode.be/wetteksten/secties/wetten/verkeerswet/456-t4hs2" target="_blank" rel="noopener noreferrer" className="text-lime hover:underline">
